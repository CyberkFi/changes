...
- Lên lại chiến lược về Lương. -> đảm bảo lương và trách nhiệm rõ ràng hơn.  -> ví dụ: Dev-lead 10%
- Lương & Thưởng -> Lương base -> trách nhiệm.
  - trách nhiệm -> nhiều việc hơn.
- Chiến lược khách hàng.
  - Discount - Khi ít việc cho khách hàng. ->
    - Không đầu tư -> làm k lấy tiền -> nếu thành công thì trả tiền.
- Cần review về cách tiếp cận quản trị.
  - Đang không có check list việc cần làm và mục tiêu.

### Mô hình tư duy: Functional Diary System

**Khái niệm:** Xây dựng hệ thống nhật ký phát triển cho từng tính năng cụ thể (Functional Requirements - FR) trong PRD.

**Hai mô hình tư duy chính:**

1. **Continuous Documentation (Tài liệu liên tục):**
   - Biến documentation từ hoạt động tĩnh thành quá trình liên tục, sống động
   - Thay vì chỉ viết tài liệu khi kết thúc, ghi chép liên tục trong quá trình làm việc
   - Mỗi FR có một file diary riêng biệt, cập nhật hằng ngày
   - Tích hợp vào AI workflow để tự động nhắc nhở và hỗ trợ

2. **Traceability Matrix (Ma trận truy vết):**
   - Tạo ra ma trận có thể truy vết được từ yêu cầu ban đầu đến implementation, testing, và deployment
   - Mỗi FR có thể theo dõi được toàn bộ quá trình phát triển
   - Phát hiện vấn đề sớm và phân tích hiệu suất
   - Cơ chế kiểm tra và điều tra khi thiếu diary

**Ứng dụng thực tế:**

- Template chuẩn cho diary với format: ngày tháng, tiến độ, vấn đề, giải pháp
- AI rules tự động nhắc nhở khi bắt đầu phát triển FR mới
- Cơ chế review định kỳ và alert khi thiếu cập nhật
